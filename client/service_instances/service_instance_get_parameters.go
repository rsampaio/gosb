...
// WithXBrokerAPIRequestIdentity adds the xBrokerAPIRequestIdentity to the service instance get params
func (o *ServiceInstanceGetParams) WithXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) *ServiceInstanceGetParams {
	o.SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity)
	return o
}

// SetXBrokerAPIRequestIdentity adds the xBrokerApiRequestIdentity to the service instance get params
func (o *ServiceInstanceGetParams) SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) {
...
// WithPlanID adds the planID to the service instance get params
func (o *ServiceInstanceGetParams) WithPlanID(planID *string) *ServiceInstanceGetParams {
	o.SetPlanID(planID)
	return o
}

// SetPlanID adds the planId to the service instance get params
func (o *ServiceInstanceGetParams) SetPlanID(planID *string) {
	o.PlanID = planID
}

// WithServiceID adds the serviceID to the service instance get params
func (o *ServiceInstanceGetParams) WithServiceID(serviceID *string) *ServiceInstanceGetParams {
	o.SetServiceID(serviceID)
	return o
}

// SetServiceID adds the serviceId to the service instance get params
func (o *ServiceInstanceGetParams) SetServiceID(serviceID *string) {
