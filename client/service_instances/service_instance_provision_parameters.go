...
// WithXBrokerAPIRequestIdentity adds the xBrokerAPIRequestIdentity to the service instance provision params
func (o *ServiceInstanceProvisionParams) WithXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) *ServiceInstanceProvisionParams {
	o.SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity)
	return o
}

// SetXBrokerAPIRequestIdentity adds the xBrokerApiRequestIdentity to the service instance provision params
func (o *ServiceInstanceProvisionParams) SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) {
