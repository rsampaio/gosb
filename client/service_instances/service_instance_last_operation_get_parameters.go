...
// WithXBrokerAPIOriginatingIdentity adds the xBrokerAPIOriginatingIdentity to the service instance last operation get params
func (o *ServiceInstanceLastOperationGetParams) WithXBrokerAPIOriginatingIdentity(xBrokerAPIOriginatingIdentity *string) *ServiceInstanceLastOperationGetParams {
	o.SetXBrokerAPIOriginatingIdentity(xBrokerAPIOriginatingIdentity)
	return o
}

// SetXBrokerAPIOriginatingIdentity adds the xBrokerApiOriginatingIdentity to the service instance last operation get params
func (o *ServiceInstanceLastOperationGetParams) SetXBrokerAPIOriginatingIdentity(xBrokerAPIOriginatingIdentity *string) {
	o.XBrokerAPIOriginatingIdentity = xBrokerAPIOriginatingIdentity
}

// WithXBrokerAPIRequestIdentity adds the xBrokerAPIRequestIdentity to the service instance last operation get params
func (o *ServiceInstanceLastOperationGetParams) WithXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) *ServiceInstanceLastOperationGetParams {
	o.SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity)
	return o
}

// SetXBrokerAPIRequestIdentity adds the xBrokerApiRequestIdentity to the service instance last operation get params
func (o *ServiceInstanceLastOperationGetParams) SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) {
