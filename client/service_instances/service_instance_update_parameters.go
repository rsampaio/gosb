...
// WithXBrokerAPIRequestIdentity adds the xBrokerAPIRequestIdentity to the service instance update params
func (o *ServiceInstanceUpdateParams) WithXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) *ServiceInstanceUpdateParams {
	o.SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity)
	return o
}

// SetXBrokerAPIRequestIdentity adds the xBrokerApiRequestIdentity to the service instance update params
func (o *ServiceInstanceUpdateParams) SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) {
