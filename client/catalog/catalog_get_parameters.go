...
// WithXBrokerAPIOriginatingIdentity adds the xBrokerAPIOriginatingIdentity to the catalog get params
func (o *CatalogGetParams) WithXBrokerAPIOriginatingIdentity(xBrokerAPIOriginatingIdentity *string) *CatalogGetParams {
	o.SetXBrokerAPIOriginatingIdentity(xBrokerAPIOriginatingIdentity)
	return o
}

// SetXBrokerAPIOriginatingIdentity adds the xBrokerApiOriginatingIdentity to the catalog get params
func (o *CatalogGetParams) SetXBrokerAPIOriginatingIdentity(xBrokerAPIOriginatingIdentity *string) {
	o.XBrokerAPIOriginatingIdentity = xBrokerAPIOriginatingIdentity
}

// WithXBrokerAPIRequestIdentity adds the xBrokerAPIRequestIdentity to the catalog get params
func (o *CatalogGetParams) WithXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) *CatalogGetParams {
	o.SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity)
	return o
}

// SetXBrokerAPIRequestIdentity adds the xBrokerApiRequestIdentity to the catalog get params
func (o *CatalogGetParams) SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) {
