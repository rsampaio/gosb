...
// WithXBrokerAPIRequestIdentity adds the xBrokerAPIRequestIdentity to the service binding binding params
func (o *ServiceBindingBindingParams) WithXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) *ServiceBindingBindingParams {
	o.SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity)
	return o
}

// SetXBrokerAPIRequestIdentity adds the xBrokerApiRequestIdentity to the service binding binding params
func (o *ServiceBindingBindingParams) SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) {
