...
// WithXBrokerAPIRequestIdentity adds the xBrokerAPIRequestIdentity to the service binding get params
func (o *ServiceBindingGetParams) WithXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) *ServiceBindingGetParams {
	o.SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity)
	return o
}

// SetXBrokerAPIRequestIdentity adds the xBrokerApiRequestIdentity to the service binding get params
func (o *ServiceBindingGetParams) SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) {
...
// WithPlanID adds the planID to the service binding get params
func (o *ServiceBindingGetParams) WithPlanID(planID *string) *ServiceBindingGetParams {
	o.SetPlanID(planID)
	return o
}

// SetPlanID adds the planId to the service binding get params
func (o *ServiceBindingGetParams) SetPlanID(planID *string) {
	o.PlanID = planID
}

// WithServiceID adds the serviceID to the service binding get params
func (o *ServiceBindingGetParams) WithServiceID(serviceID *string) *ServiceBindingGetParams {
	o.SetServiceID(serviceID)
	return o
}

// SetServiceID adds the serviceId to the service binding get params
func (o *ServiceBindingGetParams) SetServiceID(serviceID *string) {
