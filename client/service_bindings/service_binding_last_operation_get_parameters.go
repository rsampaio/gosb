...
// WithXBrokerAPIOriginatingIdentity adds the xBrokerAPIOriginatingIdentity to the service binding last operation get params
func (o *ServiceBindingLastOperationGetParams) WithXBrokerAPIOriginatingIdentity(xBrokerAPIOriginatingIdentity *string) *ServiceBindingLastOperationGetParams {
	o.SetXBrokerAPIOriginatingIdentity(xBrokerAPIOriginatingIdentity)
	return o
}

// SetXBrokerAPIOriginatingIdentity adds the xBrokerApiOriginatingIdentity to the service binding last operation get params
func (o *ServiceBindingLastOperationGetParams) SetXBrokerAPIOriginatingIdentity(xBrokerAPIOriginatingIdentity *string) {
	o.XBrokerAPIOriginatingIdentity = xBrokerAPIOriginatingIdentity
}

// WithXBrokerAPIRequestIdentity adds the xBrokerAPIRequestIdentity to the service binding last operation get params
func (o *ServiceBindingLastOperationGetParams) WithXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) *ServiceBindingLastOperationGetParams {
	o.SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity)
	return o
}

// SetXBrokerAPIRequestIdentity adds the xBrokerApiRequestIdentity to the service binding last operation get params
func (o *ServiceBindingLastOperationGetParams) SetXBrokerAPIRequestIdentity(xBrokerAPIRequestIdentity *string) {
